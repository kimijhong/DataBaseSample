package com.sample.databasesample.activitys;
...
import com.sample.databasesample.R;

public class SampleDatabaseQuery extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        queryBtn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(SampleDatabaseQuery.this,"FAIL",Toast.LENGTH_LONG).show();
                }
